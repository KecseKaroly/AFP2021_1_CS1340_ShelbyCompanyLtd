<?php
    if(isset($_POST["newentry"]))  
    {
        ...
        $query="insert into megbizas(megnevezes, suly, ar, partnercegid) values ('".$_POST['csomaginfo_megnevezes']."','"
                .$_POST['csomaginfo_suly']."','".$_POST['csomaginfo_ar']."','".$_POST['partnercegek_nev']."')";
                if(mysqli_query($con, $query))
                        echo "Records added successfully.";
                        else{
                                echo "ERROR: Could not execute $query. " . mysqli_error($con);
